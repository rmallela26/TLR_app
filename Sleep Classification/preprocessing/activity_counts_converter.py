...
def main(file, folderInn, folderOut, filesf):
    ...
    dt = pd.read_table(fileInn, delim_whitespace=True, header=0)
    ...
    # frames.append(c_1s.tail(lines_to_read))
...
path = '/Users/rishabhmallela/Documents/Sleep Classification/data/'
folderInn = path + "cleaned_motion/"
folderOut = path + "counts2/" 

file = 'cleaned_1066528_acceleration.txt'
main(file, folderInn, folderOut, filesf=50)


# files = os.listdir(f'{path}cleaned_motion/')


# # files.remove('cleaned_1360686_acceleration.txt') #data is all messed up

# files.remove('cleaned_5383425_acceleration.txt')
# files.remove('cleaned_8258170_acceleration.txt')

# files = sorted(files)


# # files = ['cleaned_5383425_acceleration.txt', 'cleaned_8258170_acceleration.txt']
...
# for file in files:
#     path = '/Users/rishabhmallela/Documents/Sleep Classification/data/cleaned_motion'
#     file_path = f'{path}/{file}'

#     f = open(f'/Users/rishabhmallela/Documents/Sleep Classification/data/temp/{file}', 'w')
#     f.write("time x y z\n")
...
#     while line < len(arr):
#         f = open(f'/Users/rishabhmallela/Documents/Sleep Classification/data/temp/{file}', 'a')
#         lines_to_read = 30
...
#                 line += 1
#             else: 
#                 lines_to_read = int((len(arr) % (30*50))/50)
#                 break
#         f.close()
#         main(file, folderInn, folderOut, lines_to_read, filesf = 30) # add an argument telling how many values to read at the end
